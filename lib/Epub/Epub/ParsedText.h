...
class ParsedText {
  ...
  bool usesCharacterWrap() const {
    return characterWrap && blockStyle.alignment == CssTextAlign::Justify && !blockStyle.isRtl && !hasRtlWord;
  }
 ...
 public:
  ...
  // False means a line could not be materialized; its source remains owned here.
