...
#define UI_10_FONT_ID (253127081)
#define UI_12_FONT_ID (253127081)
#define SMALL_FONT_ID (253127081)
#define KIMCHI_BATANG_14_FONT_ID (849410473)
...
static_assert(KIMCHI_BATANG_14_FONT_ID != 0, "Font ID collision with sentinel");
